...
<script>
    $(document).ready(function() {
        var table = $('#customer-datatable').DataTable({
            ...
            ajax: {
                url: "./pages/customer/customer_delete_ajax.php", // URL to your PHP file
                type: "GET",
                data: function(d) {
            ...
            columns: [{
                ...
                <?php if ($obj->userWorkPermission('edit') || $obj->userWorkPermission('delete')) { ?> {
                    ...
                    <a
                    onclick="return confirm('are sure this data rsotre')"
              href="?page=customer_delete_log&restore-token=` + data + `"
                    class="btn btn-success waves-effect waves-light btn-sm restore">
                    Restore
                </a>
                <a
                    onclick="return confirm('are sure this data delete')"
              href="?page=customer_delete_log&restore-token_full=` + data + `"
                    class="btn btn-danger waves-effect waves-light btn-sm restore">
                    Delete
                </a>
                <?php } ?>
                `;
