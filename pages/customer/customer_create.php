                    ...
                    <div class="card">
                        <div class="card-body">
                            <fieldset class="wizard-fieldset">
                                ...
                                <div class="row gy-3">
                                    <div class="col-sm-6">
                                        <label class="form-label">PPPOE User<span style="color:red">*</span></label>
                                    ...
                                    <div class="col-sm-6">
                                        <label class="form-label">Mikrotik Secret Password<span style="color:red">*</span></label>
                                        <div class="position-relative">
                        ...
                        <fieldset class="wizard-fieldset show">
                            ...
                            <div class="row gy-3">
                                <?php if (!$mikrotikConnect): ?>
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="ip" class="form-label">PPPOE User<span style="color:red">*</span></label>
                                ...
                                <div class="col-sm-6">
                                    <label class="form-label">Agent Type<span style="color:red">*</span></label>
                                ...
                                <div class="col-sm-6">
                                    <label class="form-label">Connection Type<span style="color:red">*</span></label>
                                ...
                                <div class="col-sm-6">
                                    <label class="form-label">Connection Date<span style="color:red">*</span></label>
                    ...
                    <div class="card-body">
                        <div class="form-wizard">
                            <fieldset class="wizard-fieldset show">
                                ...
                                <div class="row gy-3">
                                    <div class="col-sm-6">
                                        <label class="form-label">MB<span style="color:red">*</span></label>
                                    ...
                                    <div class="col-sm-6">
                                        <label class="form-label">Monthly Bill Amount<span style="color:red">*</span></label>
                                    ...
                                    <div class="col-sm-6">
                                        <label class="form-label">Running Month Paid Amount<span style="color:red">*</span></label>
                                    ...
                                    <div class="col-sm-6">
                                        <label class="form-label">Connection Fee Paid Amount<span style="color:red">*</span></label>
                                    ...
                                    <div class="col-sm-6">
                                        <label class="form-label">Disconenct Day<span style="color:red">*</span></label>
                                    ...
                                    <div class="col-sm-6">
                                        <label class="form-label">Billing Person<span style="color:red">*</span></label>
