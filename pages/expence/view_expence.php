                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4 mt-5">
                        ...
                        <div class="col-md-2" style="margin-top: 22px;">
                            <input type="submit" id="search-expenses" name="search" class="btn btn-secondary" value="Search">
                        </div>
                    </div>
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div>
                                                ...
                                                <h6 class="fw-semibold" id="totalpaid">
                                                    <i class="fa-solid fa-bangladeshi-taka-sign"></i>
                                                    <?php
                                                    echo $obj->rawSqlSingle("SELECT SUM(acc_amount) as TotalRunningMonthExpenses FROM `tbl_account` WHERE acc_type = '1' AND entry_date BETWEEN '$dateform' AND '$dateto'")["TotalRunningMonthExpenses"] ?? 0;
                                                    ?>
                                                </h6>
                                            </div>
                                        </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo isset($viewHead2['acc_name']) ? $viewHead2['acc_name'] : "N/A"; ?></td>
